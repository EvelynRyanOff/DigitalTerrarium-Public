...
-----------------------------------
Digital Terrarium Code
-----------------------------------

Instructions:


To initialize the number of particles use the command:

system partSys dim N
where N is the max number of predator and prey particles
therfore, the total number of particles after this command is 2N
-------------

To add a prey particle:
system partSys particle index mass x y z vx vy vz
-------------

To add a predator particle:
system partSys predpart index mass x y z vx vy vz

x y z are the starting coordinates

vx vy vz is the starting velocity

press s to begin simulation
500 is the highest value N can be
Therefore, the max number of particles is 1000
